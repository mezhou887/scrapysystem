...
from proxylist.items import *    #这个错误是eclipse自己的编译器错误
...
class ProxylistXpathSpider(BaseXpathSpider):
...
# 范例3，在范例2的基础上加入Redis      
class ProxylistXpathRedisSpider(RedisMixin, BaseXpathSpider):
    ...
    def _set_crawler(self, crawler):
        super(proxylistXpathRedisSpider, self)._set_crawler(crawler)
        self.setup_redis()            
