...
from zhihu.items import *    #这个错误是eclipse自己的编译器错误
...
class ZhihuXpathSpider(BaseXpathSpider):
    name = "zhihu_xpath"
    allowed_domains = ["zhihu.com"]
    start_urls = [
        "http://www.zhihu.com/",
...
# 范例3，在范例2的基础上加入Redis      
class ZhihuXpathRedisSpider(RedisMixin, BaseXpathSpider):
    name = "zhihu_redis"
    allowed_domains = ["zhihu.com"]
    start_urls = [
        "http://www.zhihu.com/",
    ...
    def _set_crawler(self, crawler):
        super(zhihuXpathRedisSpider, self)._set_crawler(crawler)
        self.setup_redis()            
